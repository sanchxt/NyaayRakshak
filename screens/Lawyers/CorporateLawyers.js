    ...
    return (
        <CaseProgContainer>
          <View style={styles.caseHeadingContainer}>
            <CaseHeading>Corporate Lawyer</CaseHeading>
            <Image 
              source={require("../../assets/img/Lawyers/lawyer-4.jpg")} // Replace with your image path
          ...
          <DateContainer>
            ...
            <CaseProgDate>Arnav Kohli</CaseProgDate>
          </DateContainer>

          <LineBreak />
          <DateContainer>
            <CaseProgDate heading={true}>Bar Council No.:</CaseProgDate>
            <CaseProgDate>UP99768/02</CaseProgDate>
          </DateContainer>

          <LineBreak />
          <DateContainer>
            <CaseProgJudge heading={true}>Email:</CaseProgJudge>
            <CaseProgJudge>arnkohli@gmail.com</CaseProgJudge>
          </DateContainer>
        </CaseProgContainer>
    );
};
