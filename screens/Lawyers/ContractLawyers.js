    ...
    return (
        <CaseProgContainer>
          <View style={styles.caseHeadingContainer}>
            <CaseHeading>Contract Lawyer</CaseHeading>
            <Image 
              source={require("../../assets/img/Lawyers/lawyer-3.png")} // Replace with your image path
          ...
          <DateContainer>
            ...
            <CaseProgDate>Deepika</CaseProgDate>
          </DateContainer>

          <LineBreak />
          <DateContainer>
            <CaseProgDate heading={true}>Bar Council No.:</CaseProgDate>
            <CaseProgDate>DL23983/14</CaseProgDate>
          </DateContainer>

          <LineBreak />
          <DateContainer>
            <CaseProgJudge heading={true}>Email:</CaseProgJudge>
            <CaseProgJudge>deepika17@gmail.com</CaseProgJudge>
          </DateContainer>
        </CaseProgContainer>
    );
};
